...
if (IS_PRODUCTION) {
    ...
    define("SUCCESS_URL", "http://nsararidades.com.br/customer/pedidos");
    define('CANCEL_URL', 'http://nsararidades.com.br/carrinho');
    ...
    //constantes para o checkout
    define("SUCCESS_URL", "http://192.168.15.4:5173/customer/pedidos");
    define('CANCEL_URL', 'http://192.168.15.4:5173/carrinho');
